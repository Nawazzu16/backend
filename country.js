...
// Define the country codes, countries, and flags
const countryCodes = [
  ...
  { code: "+225", country: "Ivory Coast (Côte d'Ivoire)", flag: "🇨🇮" },
  ...
  { code: "+268", country: "Eswatini (Swaziland)", flag: "🇸🇿" },
...
const CountryDropdown = ({ setCountryCode }) => {
  ...
  return (
    <div className="dropdown-container">
      <label htmlFor="country-dropdown" className="dropdown-label"></label>
      <select
        id="country-dropdown"
